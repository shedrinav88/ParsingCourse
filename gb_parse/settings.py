...
USER_AGENT = 'Mozilla/5.0 (Windows NT 6.3; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.150 Safari/537.36'
...
ITEM_PIPELINES = {
    ...
    'gb_parse.pipelines.GbImagePipeline': 250,
}
